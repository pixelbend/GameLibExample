package test.screens.tweenTest.view
{
	...
	public class TweenTestViewMediator extends Mediator implements IRunnable
	{
		...
		public function TweenTestViewMediator(parentMediatorName:String, parentContainer:Sprite, gameSize:GameSizeVO,
											  	titleLayout:TweenTestTitleLayoutVO, buttonLayout:TweenTestButtonLayoutVO,
													setup:TweenTestSetupVO, buttonTexturesMap:Dictionary, tweenTarget:Object)
		{

			mediatorName = parentMediatorName + MEDIATOR_NAME + setup.getTweenNameTextID();
		...
		{
			return [mediatorName + TweenTestButtonView.BUTTON_TRIGGERED];
		}
		...
		public override function handleNotification(notification:INotification):void
		{
			...
			{
				case mediatorName + TweenTestButtonView.BUTTON_TRIGGERED:
		...
		private function createTweenName(parentMediatorName:String, titleLayout:TweenTestTitleLayoutVO, setup:TweenTestSetupVO, gameSize:GameSizeVO):void
		{
		...
		private function createButtons(buttonLayout:TweenTestButtonLayoutVO, buttonTexturesMap:Dictionary, gameSize:GameSizeVO):void
		{
			var buttonVOs:Vector.<TweenTestButtonVO> = buttonLayout.getButtons(),
				buttonID:String,
				buttonView:TweenTestButtonView,
			...
			for (var i:int=0; i<buttonVOs.length; i++)
			{
				...
				buttonView = new TweenTestButtonView(mediatorName, buttonID);
